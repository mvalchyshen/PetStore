...
public final class EndPoints {
    ...
    public static final String PET_WITH_ID = PET+"/{petId}";
    public static final String UPLOAD_IMAGE_BY_ID = PET_WITH_ID+"/uploadImage";
    ...
    public static final String USERNAME = USER_END_POINT+"/{username}";
